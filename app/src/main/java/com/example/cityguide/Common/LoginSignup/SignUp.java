...
import com.example.cityguide.Database.UsersClass;
...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDBReference = rootNode.getReference("Users");

       UsersClass addNewUser = new UsersClass(fullName, username, email, password);
    }
    ...
    public void call2ndSignupScreen(View view) {
        ...
        UsersClass usersClass = new UsersClass(names, userNames,emails,passwords);
        myDBReference.child(key).setValue(usersClass);
        Toast.makeText(getApplicationContext(), "Data Successfully Done",Toast.LENGTH_LONG).show();
//
